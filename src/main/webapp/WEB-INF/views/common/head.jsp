    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/assets/fontawesome/css/fontawesome-all.min.css"/>" />

    <link rel="stylesheet" type="text/css" href="<c:url value="/assets/common/common.css"/>" />
